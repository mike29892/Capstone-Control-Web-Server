...
import com.capstonecontrol.client.MyRequestFactory.MessageRequest;
import com.capstonecontrol.shared.MessageProxy;

public class CapstoneControlWidget extends Composite {
  ...
  interface CapstoneControlUiBinder extends UiBinder<Widget, CapstoneControlWidget> {
  }

  private static CapstoneControlUiBinder uiBinder = GWT.create(CapstoneControlUiBinder.class);
