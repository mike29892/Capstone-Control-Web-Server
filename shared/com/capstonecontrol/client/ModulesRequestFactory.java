...
public interface ModulesRequestFactory extends RequestFactory {
	...
	public interface ModuleEventFetchRequest extends RequestContext {
		 ...
		 * Retrieve users modules from the server.
		 */
		Request<List<ModuleEventProxy>> getModuleEvents();
	...
	public interface ScheduledModuleEventFetchRequest extends RequestContext {
		 ...
		 * Retrieve users modules from the server.
		 */
		Request<List<ScheduledModuleEventProxy>> getScheduledEvents();

	}

	@ServiceName("com.capstonecontrol.server.PowerDataFetchService")
	public interface PowerDataFetchService extends RequestContext {
		/**
		 * Retrieve users modules from the server.
		 */
		Request<List<PowerDataProxy>> getPowerData();
	...
	PowerDataFetchService powerDataFetchService();
}
